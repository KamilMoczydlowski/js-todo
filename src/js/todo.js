...
const manageCategoryTemplate = document.querySelector('.categories-list-item-template')
...
const createCategoryErrMsg = document.querySelector('.create-category-error-msg')
const createCategoryBtnAccept = document.querySelector('.create-category-accept')
const createCategoryBtnCancel = document.querySelector('.create-category-cancel')
...
const addItem = () => {
    ...
    if (textInput.value !== '') {
        ...
        const categoryTitleUpperCase = categoryValue[0].toUpperCase() + categoryValue.slice(1)
        ...
        if (accBox) {
            ...
            if (accBox.id == categoryValue) {
                ...
                let accNumber = accBtn.querySelector('.category-todo-number').textContent
                accNumber++
                ...
                accList.previousElementSibling.querySelector('.category-arrow').classList.remove('rotate')
            }
...
const acceptEditCategoryInput = () => {
    ...
    option.textContent = editCategoryInput.value.charAt(0).toUpperCase() + editCategoryInput.value.slice(1)

    textToEdit.textContent = editCategoryInput.value.charAt(0).toUpperCase() + editCategoryInput.value.slice(1)
...
const acceptNewCategory = () => {
    ...
    newCategoryOption.textContent = createCategoryInput.value.charAt(0).toUpperCase() + createCategoryInput.value.slice(1)
